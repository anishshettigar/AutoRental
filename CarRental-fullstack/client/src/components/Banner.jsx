  ...
  return (
    ...
    >
      <div className='text-white'>
        <h2 className='text-3xl font-medium'>Do You Own a Auto?</h2>
        <p className='mt-2'>
          Monetize your vehicle effortlessly by listing it on AutoRental.
        </p>
      ...
      <motion.img
        ...
        alt='car'
        className='mt-10 ml-auto max-h-82 scale-120 -translate-y-6'
      />
    </motion.div>
  );
};
